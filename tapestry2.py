...
def bizLoc(msa=msa):
    ...
    order by datasetid, major desc, minor desc""".format(msa.lower()[0:8])
...
blocks.gpd.to_file('Tapestry_{}.geojson'.format(msa), driver='GeoJSON').format()
elapsed = (timeit.default_timer() - start_time) / 60
print('{} completed in {} minutes'.format(msa, elapsed))